...
This API provides a specialized interface for managing public browser login clients in Keycloak, ensuring they are configured with the appropriate defaults for public and browser-based login flows without silently falling back to wildcard redirect URIs.
