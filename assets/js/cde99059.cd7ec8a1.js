"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[929],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_clients_client_mdx_cde_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-clients-client-mdx-cde.json
const site_docs_fluent_api_clients_client_mdx_cde_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/clients/client","title":"Client API","description":"The ClientHandle class provides a fluent API for managing Keycloak clients. It allows you to create, update, delete, and retrieve clients within a specific realm, as well as manage client roles and protocol mappers.","source":"@site/docs/fluent-api/clients/client.mdx","sourceDirName":"fluent-api/clients","slug":"/fluent-api/clients/client","permalink":"/fluent-api/clients/client","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":0,"frontMatter":{"sidebar_label":"Client","sidebar_position":0},"sidebar":"fluentApi","previous":{"title":"Identity Provider","permalink":"/fluent-api/identity-provider"},"next":{"title":"Confidential Browser Login Client","permalink":"/fluent-api/clients/confidential-browser-login-client"}}');
...
;// ./docs/fluent-api/clients/client.mdx
