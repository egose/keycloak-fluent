"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([["21"], {
1727(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-api-client-role-mdx-2bc.json
var site_docs_api_client_role_mdx_2bc_namespaceObject = JSON.parse('{"id":"api/client-role","title":"Client Role API","description":"The ClientRoleHandle class provides a fluent API for managing roles associated with a specific client in Keycloak. It allows you to create, update, delete, and retrieve client roles, as well as list users assigned to those roles.","source":"@site/docs/api/client-role.mdx","sourceDirName":"api","slug":"/api/client-role","permalink":"/api/client-role","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":9,"frontMatter":{"sidebar_label":"Client Role","sidebar_position":9},"sidebar":"api","previous":{"title":"Realm Admin Service Account","permalink":"/api/clients/realm-admin-service-account"},"next":{"title":"Organization","permalink":"/api/organization"}}')
...
;// CONCATENATED MODULE: ./docs/api/client-role.mdx
