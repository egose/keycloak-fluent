"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[882],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_protocol_mappers_hardcoded_claim_protocol_mapper_mdx_a21_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-protocol-mappers-hardcoded-claim-protocol-mapper-mdx-a21.json
const site_docs_fluent_api_protocol_mappers_hardcoded_claim_protocol_mapper_mdx_a21_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper","title":"Hardcoded Claim Protocol Mapper API","description":"The HardcodedClaimProtocolMapperHandle class extends the ProtocolMapperHandle class and provides a specialized API for managing hardcoded claim protocol mappers in Keycloak. These mappers add a hardcoded claim to tokens issued by Keycloak.","source":"@site/docs/fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper.mdx","sourceDirName":"fluent-api/protocol-mappers","slug":"/fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper","permalink":"/fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_label":"Hardcoded Claim Protocol Mapper","sidebar_position":2},"sidebar":"fluentApi","previous":{"title":"User Attribute Protocol Mapper","permalink":"/fluent-api/protocol-mappers/user-attribute-protocol-mapper"},"next":{"title":"Audience Protocol Mapper","permalink":"/fluent-api/protocol-mappers/audience-protocol-mapper"}}');
...
;// ./docs/fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper.mdx
