"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[140],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_clients_service_account_mdx_f15_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-clients-service-account-mdx-f15.json
const site_docs_fluent_api_clients_service_account_mdx_f15_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/clients/service-account","title":"Service Account API","description":"The ServiceAccountHandle class extends the ClientHandle class and provides a specialized API for managing service account clients in Keycloak. These clients are configured to enable service accounts for programmatic access.","source":"@site/docs/fluent-api/clients/service-account.mdx","sourceDirName":"fluent-api/clients","slug":"/fluent-api/clients/service-account","permalink":"/fluent-api/clients/service-account","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"sidebar_label":"Service Account","sidebar_position":3},"sidebar":"fluentApi","previous":{"title":"Public Browser Login Client","permalink":"/fluent-api/clients/public-browser-login-client"},"next":{"title":"Realm Admin Service Account","permalink":"/fluent-api/clients/realm-admin-service-account"}}');
...
;// ./docs/fluent-api/clients/service-account.mdx
