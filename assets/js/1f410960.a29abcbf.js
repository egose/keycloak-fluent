"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[916],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_identity_provider_mdx_1f4_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-identity-provider-mdx-1f4.json
const site_docs_fluent_api_identity_provider_mdx_1f4_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/identity-provider","title":"Identity Provider API","description":"The IdentityProviderHandle class provides a fluent API for managing Keycloak identity providers. It allows you to create, update, delete, and retrieve identity providers within a specific realm.","source":"@site/docs/fluent-api/identity-provider.mdx","sourceDirName":"fluent-api","slug":"/fluent-api/identity-provider","permalink":"/fluent-api/identity-provider","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"sidebar_label":"Identity Provider","sidebar_position":7},"sidebar":"fluentApi","previous":{"title":"Client Scope","permalink":"/fluent-api/client-scope"},"next":{"title":"Client","permalink":"/fluent-api/clients/client"}}');
...
;// ./docs/fluent-api/identity-provider.mdx
