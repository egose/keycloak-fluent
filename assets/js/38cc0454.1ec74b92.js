"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[291],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_client_role_mdx_38c_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-client-role-mdx-38c.json
const site_docs_fluent_api_client_role_mdx_38c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/client-role","title":"Client Role API","description":"The ClientRoleHandle class provides a fluent API for managing roles associated with a specific client in Keycloak. It allows you to create, update, delete, and retrieve client roles, as well as list users assigned to those roles.","source":"@site/docs/fluent-api/client-role.mdx","sourceDirName":"fluent-api","slug":"/fluent-api/client-role","permalink":"/fluent-api/client-role","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":9,"frontMatter":{"sidebar_label":"Client Role","sidebar_position":9},"sidebar":"fluentApi","previous":{"title":"Realm Admin Service Account","permalink":"/fluent-api/clients/realm-admin-service-account"},"next":{"title":"Protocol Mapper","permalink":"/fluent-api/protocol-mappers/protocol-mapper"}}');
...
;// ./docs/fluent-api/client-role.mdx
