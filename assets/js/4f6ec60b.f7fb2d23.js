"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[687],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_protocol_mappers_protocol_mapper_mdx_4f6_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-protocol-mappers-protocol-mapper-mdx-4f6.json
const site_docs_fluent_api_protocol_mappers_protocol_mapper_mdx_4f6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/protocol-mappers/protocol-mapper","title":"Protocol Mapper API","description":"The ProtocolMapperHandle class provides a fluent API for managing protocol mappers in Keycloak. Protocol mappers are used to map claims or attributes to tokens issued by Keycloak.","source":"@site/docs/fluent-api/protocol-mappers/protocol-mapper.mdx","sourceDirName":"fluent-api/protocol-mappers","slug":"/fluent-api/protocol-mappers/protocol-mapper","permalink":"/fluent-api/protocol-mappers/protocol-mapper","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":0,"frontMatter":{"sidebar_label":"Protocol Mapper","sidebar_position":0},"sidebar":"fluentApi","previous":{"title":"Client Role","permalink":"/fluent-api/client-role"},"next":{"title":"User Attribute Protocol Mapper","permalink":"/fluent-api/protocol-mappers/user-attribute-protocol-mapper"}}');
...
;// ./docs/fluent-api/protocol-mappers/protocol-mapper.mdx
