...
/* import */ var _docusaurus_useDocusaurusContext__rspack_import_3 = __webpack_require__(864);
/* import */ var _theme_Layout__rspack_import_4 = __webpack_require__(556);
...
const highlights = [
    {
        ...
        description: 'Start from a realm and move through users, groups, roles, clients, identity providers, organizations, workflows, and authentication flows with resource-scoped handles.'
    },
    {
        title: 'Idempotent Scripts By Default',
        description: 'Use ensure and discard to write repeatable setup code for local environments, CI jobs, migrations, and tenant provisioning.'
    },
    {
        title: 'Operational Helpers Included',
        description: 'The fluent layer also covers cache maintenance, attack detection, user storage provider sync, client policies, server info, and who-am-i lookups.'
    }
];
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("div", {
                                    ...
                                    children: "TypeScript wrapper for the Keycloak Admin API"
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h1", {
                                    ...
                                    children: "Provision Keycloak with code that reads like intent."
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("p", {
                                    ...
                                    children: [
                                        siteConfig.title,
                                        " turns the official admin client into a fluent DSL for realms, users, clients, authentication flows, organizations, and operational endpoints. The docs now track the real API surface exercised in `src` and `tests`."
                                    ]
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("span", {
                                            children: "Realms, users, clients, and mappers"
                                        }),
                                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("span", {
                                            children: "Authentication flows and organizations"
                                        }),
                                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("span", {
                                            children: "Operational helpers for admin automation"
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("div", {
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h2", {
                        ...
                        children: "The official client, with a better working surface for automation."
                    })
                ]
            }),
            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("div", {
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h2", {
                                ...
                                children: "More than CRUD wrappers."
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                                className: `mt-4 max-w-xl text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-600'}`,
                                children: "The landing page and docs now line up with the actual codebase. That includes the resource handles people expect, plus the operational endpoints that usually force teams back into raw admin client calls."
                            })
                        ]
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("div", {
            ...
            children: [
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)(_docusaurus_Link__rspack_import_2/* ["default"] */.A, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                            className: `mt-3 text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-600'}`,
                            children: "Install the package, authenticate with `simpleAuth`, and create your first realm-scoped handles."
                        })
                    ]
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)(_docusaurus_Link__rspack_import_2/* ["default"] */.A, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                            className: `mt-3 text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-600'}`,
                            children: "Jump straight into root helpers, realm handles, identity provider mappers, workflows, and system endpoints."
                        })
                    ]
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)(_docusaurus_Link__rspack_import_2/* ["default"] */.A, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h3", {
                            className: `mt-3 text-2xl font-semibold ${isDarkTheme ? 'text-slate-50' : 'text-slate-950'}`,
                            children: "Example Guides"
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                            className: `mt-3 text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-600'}`,
                            children: "Start from an overview, then jump into focused walkthroughs for realm bootstrap, identity setup, clients, and mappers."
                        })
                    ]
                })
            ]
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                                ...
                                children: "Readable automation"
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h2", {
                                className: "mt-3 text-3xl font-bold tracking-tight sm:text-4xl",
                                children: "Keep the power of Keycloak admin APIs without carrying the ceremony everywhere."
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                                className: `mt-4 text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-700'}`,
                                children: "Use the fluent handles for day-to-day provisioning, and drop down to the underlying client whenever you need something lower level. The library stays close to Keycloak instead of inventing a parallel model."
                            })
                        ]
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
