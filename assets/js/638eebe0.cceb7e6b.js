"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([["9866"], {
5876(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-api-authentication-flow-mdx-638.json
var site_docs_api_authentication_flow_mdx_638_namespaceObject = JSON.parse('{"id":"api/authentication-flow","title":"Authentication Flow API","description":"AuthenticationFlowHandle manages realm authentication flows and the lower-level execution and required-action helpers exposed by Keycloak.","source":"@site/docs/api/authentication-flow.mdx","sourceDirName":"api","slug":"/api/authentication-flow","permalink":"/api/authentication-flow","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":8,"frontMatter":{"sidebar_label":"Authentication Flow","sidebar_position":8},"sidebar":"api","previous":{"title":"Identity Provider","permalink":"/api/identity-provider"},"next":{"title":"Client","permalink":"/api/clients/client"}}')
...
;// CONCATENATED MODULE: ./docs/api/authentication-flow.mdx
