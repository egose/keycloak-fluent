"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[851],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_groups_nested_child_group_mdx_790_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-groups-nested-child-group-mdx-790.json
const site_docs_fluent_api_groups_nested_child_group_mdx_790_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/groups/nested-child-group","title":"Nested Child Group API","description":"The NestedChildGroupHandle class provides a fluent API for managing nested child groups in Keycloak. It allows you to create, update, delete, and retrieve nested child groups within a specific parent group path.","source":"@site/docs/fluent-api/groups/nested-child-group.mdx","sourceDirName":"fluent-api/groups","slug":"/fluent-api/groups/nested-child-group","permalink":"/fluent-api/groups/nested-child-group","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_label":"Nested Child Group","sidebar_position":2},"sidebar":"fluentApi","previous":{"title":"Child Group","permalink":"/fluent-api/groups/child-group"},"next":{"title":"Client Scope","permalink":"/fluent-api/client-scope"}}');
...
;// ./docs/fluent-api/groups/nested-child-group.mdx
