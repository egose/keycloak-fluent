"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[522],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_clients_public_browser_login_client_mdx_6b3_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-clients-public-browser-login-client-mdx-6b3.json
const site_docs_fluent_api_clients_public_browser_login_client_mdx_6b3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/clients/public-browser-login-client","title":"Public Browser Login Client API","description":"The PublicBrowserLoginClientHandle class extends the ClientHandle class and provides a specialized API for managing public browser login clients in Keycloak. These clients are configured for public access and browser-based login flows.","source":"@site/docs/fluent-api/clients/public-browser-login-client.mdx","sourceDirName":"fluent-api/clients","slug":"/fluent-api/clients/public-browser-login-client","permalink":"/fluent-api/clients/public-browser-login-client","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_label":"Public Browser Login Client","sidebar_position":2},"sidebar":"fluentApi","previous":{"title":"Confidential Browser Login Client","permalink":"/fluent-api/clients/confidential-browser-login-client"},"next":{"title":"Service Account","permalink":"/fluent-api/clients/service-account"}}');
...
;// ./docs/fluent-api/clients/public-browser-login-client.mdx
