"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([["4100"], {
4870(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-api-attack-detection-mdx-497.json
var site_docs_api_attack_detection_mdx_497_namespaceObject = JSON.parse('{"id":"api/attack-detection","title":"Attack Detection API","description":"AttackDetectionHandle wraps the realm-scoped brute-force and attack-detection endpoints.","source":"@site/docs/api/attack-detection.mdx","sourceDirName":"api","slug":"/api/attack-detection","permalink":"/api/attack-detection","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":13,"frontMatter":{"sidebar_label":"Attack Detection","sidebar_position":13},"sidebar":"api","previous":{"title":"Cache","permalink":"/api/cache"},"next":{"title":"Client Policies","permalink":"/api/client-policies"}}')
...
;// CONCATENATED MODULE: ./docs/api/attack-detection.mdx
