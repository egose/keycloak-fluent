"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[286],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_quick_start_mdx_d4f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-quick-start-mdx-d4f.json
const site_docs_fluent_api_quick_start_mdx_d4f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/quick-start","title":"Quick Start","description":"You can install the package using the npm package manager.","source":"@site/docs/fluent-api/quick-start.mdx","sourceDirName":"fluent-api","slug":"/fluent-api/quick-start","permalink":"/fluent-api/quick-start","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_label":"Quick Start","sidebar_position":1},"sidebar":"fluentApi","previous":{"title":"Philosophy","permalink":"/fluent-api/philosophy"},"next":{"title":"Realm","permalink":"/fluent-api/realm"}}');
// EXTERNAL MODULE: ./node_modules/.pnpm/react@19.2.3/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(5656);
...
;// ./docs/fluent-api/quick-start.mdx
