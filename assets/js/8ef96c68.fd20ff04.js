"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([["4011"], {
3274(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-api-role-mdx-8ef.json
var site_docs_api_role_mdx_8ef_namespaceObject = JSON.parse('{"id":"api/role","title":"Role API","description":"The RoleHandle class provides a fluent API for managing Keycloak roles. It allows you to create, update, delete, and retrieve roles within a specific realm.","source":"@site/docs/api/role.mdx","sourceDirName":"api","slug":"/api/role","permalink":"/api/role","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"sidebar_label":"Role","sidebar_position":4},"sidebar":"api","previous":{"title":"User","permalink":"/api/user"},"next":{"title":"Group","permalink":"/api/groups/group"}}')
...
;// CONCATENATED MODULE: ./docs/api/role.mdx
