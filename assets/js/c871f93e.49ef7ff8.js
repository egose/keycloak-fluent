"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[685],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_groups_child_group_mdx_c87_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-groups-child-group-mdx-c87.json
const site_docs_fluent_api_groups_child_group_mdx_c87_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/groups/child-group","title":"Child Group API","description":"The ChildGroupHandle class provides a fluent API for managing child groups in Keycloak. It allows you to create, update, delete, and retrieve child groups within a specific parent group.","source":"@site/docs/fluent-api/groups/child-group.mdx","sourceDirName":"fluent-api/groups","slug":"/fluent-api/groups/child-group","permalink":"/fluent-api/groups/child-group","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_label":"Child Group","sidebar_position":1},"sidebar":"fluentApi","previous":{"title":"Group","permalink":"/fluent-api/groups/group"},"next":{"title":"Nested Child Group","permalink":"/fluent-api/groups/nested-child-group"}}');
...
;// ./docs/fluent-api/groups/child-group.mdx
