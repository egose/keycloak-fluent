"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[511],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fluent_api_protocol_mappers_user_attribute_protocol_mapper_mdx_9f3_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fluent-api-protocol-mappers-user-attribute-protocol-mapper-mdx-9f3.json
const site_docs_fluent_api_protocol_mappers_user_attribute_protocol_mapper_mdx_9f3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fluent-api/protocol-mappers/user-attribute-protocol-mapper","title":"User Attribute Protocol Mapper API","description":"The UserAttributeProtocolMapperHandle class extends the ProtocolMapperHandle class and provides a specialized API for managing user attribute protocol mappers in Keycloak. These mappers map user attributes to token claims.","source":"@site/docs/fluent-api/protocol-mappers/user-attribute-protocol-mapper.mdx","sourceDirName":"fluent-api/protocol-mappers","slug":"/fluent-api/protocol-mappers/user-attribute-protocol-mapper","permalink":"/fluent-api/protocol-mappers/user-attribute-protocol-mapper","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_label":"User Attribute Protocol Mapper","sidebar_position":1},"sidebar":"fluentApi","previous":{"title":"Protocol Mapper","permalink":"/fluent-api/protocol-mappers/protocol-mapper"},"next":{"title":"Hardcoded Claim Protocol Mapper","permalink":"/fluent-api/protocol-mappers/hardcoded-claim-protocol-mapper"}}');
...
;// ./docs/fluent-api/protocol-mappers/user-attribute-protocol-mapper.mdx
