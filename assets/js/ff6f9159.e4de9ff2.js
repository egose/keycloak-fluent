"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[255],{
...
;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-api-user-mdx-ff6.json
const site_docs_api_user_mdx_ff6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"api/user","title":"User API","description":"The UserHandle class provides a fluent API for managing Keycloak users. It allows you to create, update, delete, and manage user roles, groups, and other attributes within a specific realm.","source":"@site/docs/api/user.mdx","sourceDirName":"api","slug":"/api/user","permalink":"/api/user","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"sidebar_label":"User","sidebar_position":3},"sidebar":"api","previous":{"title":"Realm","permalink":"/api/realm"},"next":{"title":"Role","permalink":"/api/role"}}');
